...
# What is a string?
# Is a sequence of characters. It can be defined with either single
# or double quotes.
# single quotes.
alpha = 'Hello'
...
# characters -1 you will generate a error
# print(charlie[5])
...
# negative numbers we use negative numbers. Instead of starting from zero
...
# escape sequences allows you to use some characters that are reserved using
# a backslash
