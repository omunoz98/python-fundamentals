# All about numbers
# Numeric types are broke down to 3 distinct categories: int.float & complex
...
# Numeric System, the method below will convert an integer to different
# system values
print(bin(22))
print(oct(22))
print(hex(22))
...
# input method allows for uses to provide information for us to use
